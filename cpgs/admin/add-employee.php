                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Add Citizen Section</h4>
                            <ul class="breadcrumbs pull-left"> 
                                <li><a href="employees.php">Citizen</a></li>
                                <li><span>Add</span></li>
                        ...
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addemp" method="POST">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted font-14 mb-4">Please fill up the form in order to add citizen records</p>
                                        ...
                                        <div class="form-group">
                                            <label class="col-form-label">Preferred Services</label>
