                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left" style="color:orangered">Complaint Details</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="dashboard.php">Home</a></li>
                                <li><span>Complaint Details</span></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <h4 class="user-name dropdown-toggle" data-toggle="dropdown">Redressal Committee <i class="fa fa-angle-down"></i></h4>
                    ...
                    <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <tr>
                                     <td ><b>Complaint Conditions: </b></td>
                                     <td colspan="5"><?php echo htmlentities($result->Description);?></td>
                                          
                                </tr>

                                <tr>
                                    <td ><b>Redressal Committee Remark: </b></td>
                                    <td colspan="12"><?php
                                ...
                                <tr>
                                <td ><b>Redressal Committee Action On: </b></td>
                                    <td><?php
