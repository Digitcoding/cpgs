...
<head>
    ...
    <title>Redressal Committee Panel </title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left" style="color:orangered">Service Section</h4>
                            <ul class="breadcrumbs pull-left">
                                <li><a href="department.php">Service</a></li>
                                <li><span>Add</span></li>
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form method="POST">
                                 <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">Please fill up the form in order to add new Services</p>
